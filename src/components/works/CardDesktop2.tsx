...
const Card = () => {
  // add hover command when transition is required
  return (
    <div className="rounded-3xl bg-[#573FEA]">
      <div className=" relative flex justify-between gap-32 rounded-3xl border border-solid border-black bg-[#FEE4FF] px-24 py-24 pt-28  shadow-workCard duration-500 ease-card-up transform-style-3d translate-z-0 skew-x-0 skew-y-0 scale3d-100 ">
        <ComingSoonButton />
        <div className="basis-3/6 text-center">
          ...
          <p className="mb-16 font-medium  opacity-70">
            Experience by offering complimentary seat selection and meals,
            allowing passengers to enjoy added comfort and convenience without
            additional costs.
          </p>
