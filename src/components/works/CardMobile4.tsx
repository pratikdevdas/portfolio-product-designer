...
const Card = () => {
  return (
    <div className="rounded-3xl bg-[#573FEA] hover:transition-all">
      <div className="flex justify-between gap-32 rounded-3xl border border-solid border-black bg-[#A0EBBE] px-24 pt-28 shadow-workCard duration-500 ease-card-up transform-style-3d translate-z-0 skew-x-0 skew-y-0 scale3d-100 hover:-translate-y-[1.25rem] hover:translate-x-[0.5rem] hover:rotate-2 ">
        <div className="mt-4 text-center flex flex-col justify-center">
		  ...
		  The redesign of the Sodexo Brazil App, a pivotal project that aimed to enhance the user experience and functionality of this essential tool for both consumers and businesses.
          </p>
          <Link href="">
        ...
        <div className="flex-shrink-0 rounded-t-[20px] border border-b-0 border-solid border-black bg-white px-5 pt-9 shadow-workCardMobile">
          <Image width={360} height={500} src="/workpage/sodexobrazil.png" alt="flight" />
        </div>
      </div>
    </div>
  )
